 ...
 */
#ifndef RTW_HEADER_q_heli3d_skeleton_h_
#define RTW_HEADER_q_heli3d_skeleton_h_
#ifndef q_heli3d_skeleton_COMMON_INCLUDES_
# define q_heli3d_skeleton_COMMON_INCLUDES_
#include <math.h>
#include <float.h>
#include <string.h>
#include "rtwtypes.h"
...
#include "rt_look.h"
#include "rt_look1d.h"
#endif                                 /* q_heli3d_skeleton_COMMON_INCLUDES_ */

#include "q_heli3d_skeleton_types.h"
...
#define q_heli3d_skeleton_rtModel      RT_MODEL_q_heli3d_skeleton
...
struct Parameters_q_heli3d_skeleton_ {
  ...
  real_T desvel_Value;                 /* Expression: 0
                                        ...
                                        */
  real_T Gain2_Gain_d[12];             /* Expression: K
...
struct RT_MODEL_q_heli3d_skeleton {
  const char_T *path;
...
extern Parameters_q_heli3d_skeleton q_heli3d_skeleton_P;

/* Block signals (auto storage) */
extern BlockIO_q_heli3d_skeleton q_heli3d_skeleton_B;

/* Continuous states (auto storage) */
extern ContinuousStates_q_heli3d_skele q_heli3d_skeleton_X;

/* Block states (auto storage) */
extern D_Work_q_heli3d_skeleton q_heli3d_skeleton_DWork;
...
extern void q_heli3d_skeleton_SetEventsForThisBaseStep(boolean_T *eventFlags);
extern void q_heli3d_skeleton_initialize(void);
extern void q_heli3d_skeleton_step0(void);
extern void q_heli3d_skeleton_step(int_T tid);
extern void q_heli3d_skeleton_terminate(void);

/* Real-time Model object */
extern struct RT_MODEL_q_heli3d_skeleton *const q_heli3d_skeleton_M;
 ...
 *
 * '<Root>' : 'q_heli3d_skeleton'
 * '<S1>'   : 'q_heli3d_skeleton/3-DOF Plant'
 * '<S2>'   : 'q_heli3d_skeleton/Desired Angle from Program'
 * '<S3>'   : 'q_heli3d_skeleton/Desired Position from Joystick'
 * '<S4>'   : 'q_heli3d_skeleton/Observer'
 * '<S5>'   : 'q_heli3d_skeleton/appendZeros'
 * '<S6>'   : 'q_heli3d_skeleton/Desired Angle from Program/Constant: Elevation (deg)'
 * '<S7>'   : 'q_heli3d_skeleton/Desired Angle from Program/Constant: Travel (deg)'
 * '<S8>'   : 'q_heli3d_skeleton/Desired Angle from Program/Manual Switch'
 * '<S9>'   : 'q_heli3d_skeleton/Desired Angle from Program/Repeating Sequence'
 * '<S10>'  : 'q_heli3d_skeleton/Desired Angle from Program/deg to rad'
 * '<S11>'  : 'q_heli3d_skeleton/Desired Position from Joystick/Convert (-1,1) to (0,1)'
 * '<S12>'  : 'q_heli3d_skeleton/Desired Position from Joystick/deg to rad'
 */
#endif                                 /* RTW_HEADER_q_heli3d_skeleton_h_ */
